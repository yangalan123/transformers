...
do
    ...
    python run_glue_no_trainer_iterative_train.py \
      ...
      --output_dir ./output_no_trainer_iterative_fewshot/output_iterative_train_stateful_$TASK_NAME/${model}_lr_${lr}_div_${times_lr_decay}_sd_${seed}_epoch_${num_train_epochs}_warmup_prop_${num_warmup_steps_prop}_noised_alpha_${noised_alpha}_start_with_pos_embed_ln_clf 
      #--output_dir ./output_no_trainer_iterative/output_iterative_train_stateful_$TASK_NAME/${model}_lr_${lr}_div_${times_lr_decay}_sd_${seed}_epoch_${num_train_epochs}_warmup_prop_${num_warmup_steps_prop}_noised_alpha_${noised_alpha}_start_with_clf_embed 
